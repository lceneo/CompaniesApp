var CompanyDetailedInfo = /** @class */ (function () {
    ...
    CompanyDetailedInfo.prototype.createMap = function () {
        ...
        // @ts-ignore
        ymaps.ready(function () { return new ymaps.Map(document.querySelector(".company-location"), {
